...
$nombre_archivo_actual = basename($_SERVER['PHP_SELF']); // camisetas.php
$id_categoria_actual_page = 4; // ID de la categoría "Camisetas"
$nombre_pagina_actual = "Camisetas";
...
if (isset($_GET['accion']) && $_GET['accion'] == 'obtener_detalles_producto' && isset($_GET['id_producto'])) {
    ...
    $respuesta = ['error' => 'No se pudieron obtener los detalles de la camiseta.'];
    if ($id_producto_solicitado > 0 && isset($conn)) {
        try {
            ...
            } else { $respuesta = ['error' => 'Camiseta no encontrada o no pertenece a esta categoría.']; }
    ...
    <main class="main-content">
        ...
        <form id="filterForm" method="GET" action="<?php echo htmlspecialchars($nombre_archivo_actual); ?>">
            <?php 
                ...
                // El filtro de sesión se maneja por los enlaces, el de precio por el input range.
            ?>
